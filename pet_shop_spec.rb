...
class TestPetShop < Minitest::Test
  ...
  def test_total_cash
    ...
    assert_equal(5200, sum)
  end

  def test_add_or_remove_cash__add
    add_or_remove_cash(@pet_shop)
    cash = total_cash(@pet_shop)
    assert_equal(5200, cash)
  end
  ...
  def test_pets_sold
    ...
    assert_equal(5200, sold)
  end

  def test_increase_pets_sold
    increase_pets_sold(@pet_shop)
    sold = pets_sold(@pet_shop)
    assert_equal(5200, sold)
  end
  ...
  def test_customer_cash
    ...
    assert_equal([:cash], cash) # 1000 instead of :cash
  end
  ...
  def test_add_pet_to_customer
    ...
    assert_equal(nil, customer_pet_count(customer))
  end
